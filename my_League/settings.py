"""
Django settings for my_League project.
...
SECRET_KEY = ')dapc+g6(2%=2wg+f8(#d(a@qe^lbs@up!xeg*hp-#!yzc@18)'
...
WSGI_APPLICATION = 'my_League.wsgi.application'
